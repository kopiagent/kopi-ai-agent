...
This is an additive Kopi extension surfaced under ACP ``_meta.kopi`` so
...
compression rotates the internal Kopi head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_kopi_session_id: The live internal Kopi DB session id
    ...
    provenance: Dict[str, Any] = {
        ...
        "currentKopiSessionId": current_kopi_session_id,
        "rootKopiSessionId": root_id,
        "parentKopiSessionId": parent_id,
        "sessionKind": "continuation" if is_continuation else "root",
        "compressionDepth": compression_depth,
    }
    if previous_kopi_session_id:
        provenance["previousKopiSessionId"] = previous_kopi_session_id
    if rotated:
