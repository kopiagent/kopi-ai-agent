"""ACP auth helpers — detect and advertise Kopi authentication methods."""
...
def build_auth_methods() -> list[Any]:
    """Return registry-compatible ACP auth methods for Kopi.
    ...
    not have Kopi provider credentials configured yet, so Kopi always
    ...
    if provider:
        methods.append(
            AuthMethodAgent(
                ...
                description=(
                    "Authenticate Kopi using the currently configured "
