...
def _slack_tools_loaded() -> bool:
    ...
    Two independent paths grant Slack capability:
      1. Native `slack` toolset enabled via `kopi tools` (opt-in, default
...
def build_channel_continuity_note(
    ...
    return (
        f"[System note: This {where} had an earlier Kopi session "
    ...
    def _append_to_transcript_serialized(
        ...
        while True:
            try:
                ...
                from kopi_state import CompressionSessionClosedError
