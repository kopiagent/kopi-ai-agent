...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Kopi session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Kopi session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Kopi agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Kopi Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Kopi gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Kopi session in it",
