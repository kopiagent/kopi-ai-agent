...
# dashboard's pre-write mutation validation (kopi_cli/web_server.py) so
...
class PlatformConfig:
    ...
    # "Kopi is thinking…"). Platforms with textless indicators (Discord,
...
def load_gateway_config() -> GatewayConfig:
    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            # (e.g. via `kopi config set gateway.<key> ...`, which naturally
