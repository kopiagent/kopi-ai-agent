...
Extracted verbatim from kopi_state.py so the SessionDB mixin modules
(kopi_state_search / kopi_state_schema / kopi_state_portability) can
reference them without importing kopi_state (which would be a cycle).
kopi_state re-imports every name here for backward compatibility.
"""
