/**
 * Kopi Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 ...
 *
 * Versioning: bump ``KopiPluginSDK["sdkVersion"]`` (and the
...
export interface KopiPluginSDK {
...
declare global {
  interface Window {
    __KOPI_PLUGIN_SDK__?: KopiPluginSDK;
