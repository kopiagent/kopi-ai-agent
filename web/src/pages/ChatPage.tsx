...
const PTY_ATTACH_TOKEN_KEY = "kopi.pty.token.chat";
...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      // even when the inner Kopi TUI has enabled xterm mouse-events
    ...
    //      payloads upload to KOPI_HOME/images then drive `/image`.
    //
    ...
    // must upload browser bytes to KOPI_HOME/images, then drive `/image`
