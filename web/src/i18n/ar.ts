...
export const ar = defineLocale({
  ...
  pluginsPage: {
    ...
    headline:
      "اكتشف وثبِّت وفعِّل وحدِّث مكوِّنات Kopi الإضافية (مطابقة `kopi plugins`).",
    ...
    removeConfirm: "إزالة هذا المكوِّن الإضافي من ~/.kopi/plugins/؟",
    removeHint: "يمكن إزالة المكوِّنات المثبتة من المستخدم تحت ~/.kopi/plugins فقط.",
  ...
  skills: {
    ...
    categories: "الفئات",
    filters: "الفلاتر",
    noSkills: "لم يُعثر على مهارات. يتم تحميل المهارات من ~/.kopi/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "إنجازات Kopi",
      subtitle:
        "شارات Kopi قابلة للجمع مكتسبة من سجل الجلسات الفعلي. الإنجازات غير المكتملة المعروفة تُعرض كـ Discovered؛ تبقى الإنجازات السرية مخفية حتى يظهر السلوك المطابق لأول مرة.",
      scan_subtitle:
        "فحص سجل جلسات Kopi. يمكن أن يستغرق الفحص الأول 5–10 ثوانٍ على السجلات الكبيرة.",
    },
    actions: {
      rescan: "إعادة الفحص",
    },
    stats: {
      ...
      latest: "الأحدث",
      latest_hint_empty: "شغِّل Kopi أكثر",
    ...
    guide: {
      ...
      secret_body:
        "تخفى الأسرار محددها الدقيق. بمجرد أن ترى Kopi إشارة ذات صلة، تصبح البطاقة مكتشفة وتعرض متطلباتها.",
      scan_status_header: "حالة الفحص",
      scan_status_body:
        "تُفحص Kopi السجل المحلي مرة واحدة، ثم تظهر البطاقات تلقائيًا. لا يوجد توقف إذا استغرق هذا بضع ثوانٍ.",
    ...
    share: {
      ...
      tweet_text: "فتحت للتو {tier_part}\"{name}\" في Kopi Agent ☤"
    },
  },
