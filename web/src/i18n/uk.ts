...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateHermes: "Оновити KOPI",
    updatingHermes: "Оновлення KOPI…",
  ...
  env: {
    ...
    customHint: "Довільні змінні середовища, збережені у вашому .env, які KOPI не розпізнає. Використовуйте їх для впровадження змінних середовища для навичок, серверів MCP або власних інструментів.",
