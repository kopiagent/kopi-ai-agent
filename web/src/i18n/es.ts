...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateHermes: "Actualizar KOPI",
    updatingHermes: "Actualizando KOPI…",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que KOPI no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
