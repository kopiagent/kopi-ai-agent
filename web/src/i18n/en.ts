...
export const en: Translations = {
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Kopi doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
