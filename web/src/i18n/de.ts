...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateHermes: "KOPI aktualisieren",
    updatingHermes: "KOPI wird aktualisiert…",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die KOPI nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
