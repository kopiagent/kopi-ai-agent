 ...
 * across theme x background scenes to <tmpdir>/kopi-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@kopi/ink'
...
// The regenerated slate light_colors block from kopi_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/kopi-ai-agent',
...
const setup = (bgHex: string) => {
  process.env.KOPI_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
