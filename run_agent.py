...
# / ``kopi update``) rewrites the source tree underneath a running process,
...
def _safe_session_filename_component(session_id: str) -> str:
    ...
    ``X-Kopi-Session-Id`` API header) and are otherwise interpolated raw
...
class AIAgent:
    ...
    def _ensure_db_session(self) -> None:
        ...
        try:
            ...
            # `kopi --resume`. set_session_yolo() no-ops on a missing row, so
    ...
    def _decorate_xai_entitlement_error(detail: str) -> str:
        ...
        SuperGrok subscribers can use Kopi against xai-oauth.  Lots of
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        try:
            from kopi_cli import lifecycle as _lifecycle
    ...
    def _save_session_log(self, messages: List[Dict[str, Any]] = None):
        ...
        # untrusted input (X-Kopi-Session-Id header) and must not escape
    ...
    def interrupt(self, message: Optional[str] = None, *, hard_cancel: bool = False) -> None:
        ...
        # interrupt event rather than Kopi' per-thread flag.
    ...
    def redirect(self, text: str) -> bool:
        ...
        During a normal Kopi model request this cancels only that request;
    ...
    def close(self) -> None:
        ...
        # a private embedded daemon when Kopi YOLO selected unrestricted
    ...
    def _try_refresh_env_client_credentials(self) -> bool:
        """Adopt ~/.kopi/.env credential/base-url edits at the turn boundary.

        A Settings save (desktop ``PUT /api/env``, ``kopi setup``) updates
        ...
        if (
            ...
            if self.provider == "kimi-coding":
                from kopi_cli.auth import _resolve_kimi_base_url

                base_url = _resolve_kimi_base_url(
                    api_key, pconfig.inference_base_url, env_url
                ).rstrip("/")
            elif self.provider == "zai":
                from kopi_cli.auth import _resolve_zai_base_url
    ...
    def _apply_client_headers_for_base_url(
        ...
        *,
        ...
        if base_url_host_matches(base_url, "openrouter.ai"):
            ...
            self._client_kwargs["default_headers"] = kopi_xai_default_headers()
        else:
    ...
    def _ollama_supports_thinking_cached(self) -> bool:
        ...
        try:
            from kopi_cli.models import ollama_model_supports_thinking
    ...
    def _compress_context(
        ...
        *,
        ...
        try:
            ...
            # id rotation updated kopi_logging._session_context (a
            ...
            # KOPI_SESSION_ID to the child id after an out-of-place
    ...
    def run_conversation(
        ...
        from kopi_cli.observability.relay_shared_metrics import (
            finish_task_run,
            start_task_run,
        )
