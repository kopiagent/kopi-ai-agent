/**
 * Kopi desktop plugin template. Save as:
 *   <kopi home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <kopi home> is ~/.kopi by default, or ~/.kopi/profiles/<name>
 * when running a named profile (`kopi -p <name>`). Run `kopi doctor` (or
 ...
 * Only these imports resolve: @kopi/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@kopi/plugin-sdk'
