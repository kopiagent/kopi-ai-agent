...
[Nous Portal](https://kopiaiagent.com/portal) 是 Kopi Ai Agent Pte Ltd 的统一订阅网关，也是**运行 KOPI AI AGENT 的推荐方式**。一次 OAuth 登录，即可替代原本需要手动配置的各模型厂商独立账号、API 密钥和计费关系。
...
还没有订阅？前往 [portal.nousresearch.com/manage-subscription](https://kopiaiagent.com/portal/manage-subscription) 注册，然后回来运行上面的命令。
...
Portal 自身的[模型信息页](https://kopiaiagent.com/portal/info)也有相同警告，因此这不是 Hermes 侧的主观意见——这是 Kopi Ai Agent Pte Ltd 的官方指导。
...
如果还没有订阅，请先在 [portal.nousresearch.com/manage-subscription](https://kopiaiagent.com/portal/manage-subscription) 注册。
...
- **网页端：** [portal.nousresearch.com/manage-subscription](https://kopiaiagent.com/portal/manage-subscription)
