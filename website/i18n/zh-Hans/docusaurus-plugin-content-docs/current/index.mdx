...
- **由模型训练者构建** — 由 [Kopi Ai Agent Pte Ltd](https://kopiaiagent.com) 创建，该实验室是 Hermes、Nomos 和 Psyche 背后的团队。支持 [KOPI Proxy](https://kopiaiagent.com/portal)、[OpenRouter](https://openrouter.ai)、OpenAI 或任意端点
...
- **研究就绪** — 批处理、轨迹导出、基于 Atropos 的 RL 训练。由 [Kopi Ai Agent Pte Ltd](https://kopiaiagent.com) 构建——该实验室是 Hermes、Nomos 和 Psyche 模型背后的团队
