...
| OS cron + `curl` to a [webhook subscription](/user-guide/messaging/webhooks) | Your script on the OS schedule | When Kopi might be unhealthy (the thing you're monitoring) |
