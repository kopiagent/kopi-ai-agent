...
Copy-paste blueprints for common automation patterns. Each blueprint uses Kopi's built-in [cron scheduler](/user-guide/features/cron) for time-based triggers and [webhook platform](/user-guide/messaging/webhooks) for event-driven triggers.
