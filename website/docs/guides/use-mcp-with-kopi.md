...
description: "A practical guide to connecting MCP servers to Kopi Agent, filtering their tools, and using them safely in real workflows"
---

# Use MCP with Kopi

This guide shows how to actually use MCP with Kopi Agent in day-to-day workflows.
...
Use [Open Scaffold](https://github.com/graphanov/open-scaffold) when you want Kopi to read a repository's durable AI-work record: mission, plans, evidence notes, handoff packets, and review/gate results. Kopi remains the agent; Open Scaffold remains the repo-local record.
...
- Its write tools require the server to be started with `--allow-write`; do not enable that until you explicitly want Kopi to mutate `.osc` files.
- Open Scaffold records and gates work; it does not authorize Kopi to merge, publish, deploy, or spawn runtimes.
