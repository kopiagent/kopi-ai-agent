...
:::tip
If you're paying KOPI Proxy for an xAI model anyway, Live Search calls bill against the same xAI key configured for chat. See [KOPI Proxy](/integrations/subscription-proxy).
:::
