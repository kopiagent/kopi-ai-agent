...
Paid [Nous Portal](https://kopiaiagent.com/portal) subscribers can use web search, image generation, TTS, and browser automation through the **[Tool Gateway](tool-gateway.md)** — no separate API keys needed. Run `kopi model` to enable it, or configure individual tools with `kopi tools`.
:::
