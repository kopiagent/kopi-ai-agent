...
description: "Plugins shipped with Kopi Agent that run automatically via lifecycle hooks — disk-cleanup and friends"
---
...
See the [Plugins](/user-guide/features/plugins) page for the general plugin system, and [Build a Kopi Plugin](/developer-guide/plugins) to write your own.
...
Bundled plugins are written exactly like any other Kopi plugin — see [Build a Kopi Plugin](/developer-guide/plugins). The only differences are:
