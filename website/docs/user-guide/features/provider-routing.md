...
:::tip
Traffic routed through [KOPI Proxy](/integrations/subscription-proxy) still respects per-model routing and priority configs — and KOPI Proxy subscribers get 10% off token-billed providers.
:::
