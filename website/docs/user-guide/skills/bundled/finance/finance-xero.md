---
title: "Xero — Xero accounting via MCP: read orgs, contacts, invoices, accounts, reports, tax rates; create with care"
sidebar_label: "Xero"
...
Xero accounting via MCP: read orgs, contacts, invoices, accounts, reports, tax rates; create with care.
...
| Path | `skills/finance/xero` |
| Version | `1.0.0` |
| Author | KOPI AI AGENT |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `xero`, `accounting`, `finance`, `bookkeeping`, `invoices`, `reports`, `mcp` |
| Related skills | [`quickbooks`](/docs/user-guide/skills/bundled/finance/finance-quickbooks) |
