...
sidebar_position: 5
title: "WhatsApp"
description: "Set up Kopi Agent as a WhatsApp bot via the built-in Baileys bridge"
---
...
- Agent responses are prefixed with "⚕ **Kopi Agent**" by default. You can customize or disable this in `config.yaml`:
