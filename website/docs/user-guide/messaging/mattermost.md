...
Kopi Agent uses your Mattermost User ID to control who can interact with the bot. To find it:
...
- **No extra dependencies**: The adapter uses `aiohttp` for HTTP and WebSocket, which is already included with Kopi Agent.
