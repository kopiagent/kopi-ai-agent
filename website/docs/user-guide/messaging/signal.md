...
sidebar_position: 6
title: "Signal"
description: "Set up Kopi Agent as a Signal messenger bot via signal-cli daemon"
---
...
Signal does not support editing already-sent messages. Kopi therefore suppresses gateway tool-progress bubbles on Signal, even when `/verbose` is enabled and saves a non-`off` mode for the platform.
