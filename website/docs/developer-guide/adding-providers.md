...
description: "How to add a new inference provider to Kopi Agent — auth, runtime resolution, CLI flows, adapters, tests, and docs"
---
...
- OAuth or token refresh (KOPI Proxy, Codex, Qwen Portal, Copilot)
