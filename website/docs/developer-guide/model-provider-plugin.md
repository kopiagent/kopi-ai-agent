...
description: "How to build a model provider (inference backend) plugin for Kopi Agent"
---
...
| `oauth_external` | User signs in elsewhere, tokens land in `auth.json` | Anthropic OAuth, MiniMax OAuth, Qwen Portal, KOPI Proxy |
...
See [Building a Kopi Plugin](/developer-guide/plugins#distribute-via-pip) for the full entry-points setup.
...
- [Building a Kopi Plugin](/developer-guide/plugins) — general plugin authoring
