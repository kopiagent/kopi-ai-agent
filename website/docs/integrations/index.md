...
- **[AI Providers](/integrations/providers)** — OpenRouter, Anthropic, OpenAI, Google, and any OpenAI-compatible endpoint. Kopi auto-detects capabilities like vision, streaming, and tool use per provider.
