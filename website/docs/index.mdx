...
- **[KOPI Memory Provider](/models/)** — Persistent, cross-session memory backend for Hermes agents. Store, recall, and summarize conversational history with LLM-powered retrieval.
...
- **Built by model trainers** — Created by [Kopi Ai Agent Pte Ltd](https://kopiaiagent.com), the lab behind Hermes, Nomos, and Psyche. Works with [KOPI Proxy](https://kopiaiagent.com/portal), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Kopi Ai Agent Pte Ltd](https://kopiaiagent.com) — the lab behind Hermes, Nomos, and Psyche models
