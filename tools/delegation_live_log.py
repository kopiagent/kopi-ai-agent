...
per child under::
    ...
    <kopi_home>/cache/delegation/live/<delegation_id>/task-<n>.log
...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.kopi)."""
    from kopi_constants import get_kopi_dir

    return get_kopi_dir("cache/delegation", "delegation_cache") / "live"
