...
# Cache validation (mirrors kopi_cli/profiles.py::_count_skills, d5eee133e):
...
def _find_all_skills(*, skip_disabled: bool = False) -> List[Dict[str, Any]]:
    ...
    # (_skills_dir() resolves the LIVE profile KOPI_HOME; the module-level
            ...
            try:
                ...
                if is_org_mirror_path(skill_dir, active_skills_dir):
                    ...
                    header = (
                        ...
                        "them back with\n"
                        "> `kopi sync propose` (or automatically, if your "
                        "org enables it).\n\n"
                    )
