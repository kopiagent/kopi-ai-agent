...
def check_session_search_requirements() -> bool:
    ...
    try:
        from kopi_state import _default_db_path
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Kopi conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Kopi renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Kopi conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Kopi profile's database "
