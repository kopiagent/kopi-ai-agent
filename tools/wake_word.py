"""Wake-word ("Hey Kopi") detection — hands-free session trigger for the CLI.
...
fresh voice session without touching the keyboard: say the wake word, Kopi
...
* **openwakeword** (default, free, no API key) — loads a pretrained or custom
  ...
  "hey kopi" (training guide in the wake-word docs).
