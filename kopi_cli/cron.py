            ...
            if last_error:
                ...
                if "Permission denied" in last_error:
                    print(color(
                        ...
                        "(e.g. rewritten by a root `docker exec kopi "
                        "kopi cron ...`). Fix ownership to match the "
...
def cron_command(args):
    ...
    print("Usage: kopi cron [list|create|edit|pause|resume|run|remove|status|runs|tick]")
    sys.exit(1)
