...
Shows the status of all Kopi Agent components.
"""
...
def show_status(args):
    """Show status of all Kopi Agent components."""
    ...
    try:
        ...
        # Read-only display: use the refresh-free snapshot so `kopi status`
    ...
    if terminal_env == "ssh":
        ...
        sdk_label = "installed" if sdk_ok else "missing (install: pip install 'kopi-ai-agent[vercel]')"
