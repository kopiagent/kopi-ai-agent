...
# xAI's public API is OpenAI-compatible for the endpoints Kopi commonly
# uses. The Responses endpoint is included because Kopi' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via Kopi-managed OAuth credentials."""
