...
def _oauth_tokens_present(name: str) -> bool:
    ...
    try:
        ...
        return KopiTokenStorage(name).has_cached_tokens()
...
def _reauth_oauth_server(name: str, server_config: dict) -> bool:
    ...
    #
    # force_interactive_oauth: `kopi mcp login` is *explicitly* user-
    # initiated even when stdin isn't a TTY (Kopi desktop / agent-
