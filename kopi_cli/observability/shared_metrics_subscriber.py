"""Relay subscriber for the persisted Kopi shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Kopi counters from Relay lifecycle events."""
    ...
    def __init__(
        ...
        *,
        ...
        self.store = store
        self._kopi_version = kopi_version or "unknown"
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Kopi shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
