"""Kopi skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Kopi itself) customize the
visual appearance across the CLI, the TUI, and the desktop GUI from a single
file. Skins are defined as YAML files in ~/.kopi/skins/ or as built-in presets.
...
``resolve_skin`` / ``skin.changed``). A skin dropped in ~/.kopi/skins/ therefore
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Kopi Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Kopi Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        # and the TUI render the same Kopi gold.
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Kopi Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Kopi ",
            "prompt_symbol": "❯",
