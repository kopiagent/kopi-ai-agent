...
def _has_agent_browser() -> bool:
    ...
    from kopi_constants import agent_browser_runnable, with_kopi_node_path
    ...
    # Kopi-managed Node dirs (Windows installer / POSIX $KOPI_HOME/node)
    ...
    managed_path = with_kopi_node_path().get("PATH", "")
    if managed_path:
