...
TIPS = [
    ...
    "kopi chat --max-turns 1000 overrides the default 500-iteration limit per turn.",
    ...
    "Profiles scope Kopi state via KOPI_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    'kopi dashboard embeds the full Kopi TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'kopi import restores a full Kopi backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
