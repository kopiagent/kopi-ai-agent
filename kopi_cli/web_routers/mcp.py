...
web_server - reached via the late-binding seam in :mod:`kopi_cli.web_deps`
...
from kopi_cli.web_deps import late, LateState
from kopi_cli.web_models import (
    MCPCatalogInstall,
    MCPEnabledToggle,
    MCPServerCreate,
    MCPServersReplace,
...
_log = logging.getLogger("kopi_cli.web_server")
...
_spawn_kopi_action = late("_spawn_kopi_action")
