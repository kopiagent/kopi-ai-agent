"""``kopi sessions`` command — extracted from ``kopi_cli/main.py``.
...
Helpers that stay in ``kopi_cli.main`` (``get_kopi_home``,
...
``kopi_cli.main.<name>`` keep reaching this code path, and so imports stay
