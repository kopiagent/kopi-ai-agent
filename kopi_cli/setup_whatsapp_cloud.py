...
Kopi gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Kopi to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Kopi needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Kopi gateway in another terminal:")
    print("         kopi gateway")
    print()
