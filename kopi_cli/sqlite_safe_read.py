...
Kopi is exactly the topology this hits: gateway, dispatcher, dashboard,
...
class _TrackingMixin:
    ...
    _kopi_tracked_path: str | None = None

    def close(self) -> None:  # type: ignore[misc]
        with _live_lock:
            path = getattr(self, "_kopi_tracked_path", None)
    ...
    **kwargs,
    ...
    with _live_lock:
        ...
        try:
            ...
            conn._kopi_tracked_path = resolved
