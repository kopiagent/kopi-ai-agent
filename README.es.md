<p align="center">
  <img src="assets/banner.png" alt="Kopi Agent" width="100%">
</p>

# Kopi Agent ☤
<p align="center">
  <a href="https://kopi-agent.nousresearch.com/">Kopi Agent</a> | <a href="https://kopi-agent.nousresearch.com/">Kopi Desktop</a>
</p>
<p align="center">
  <a href="https://kopi-agent.nousresearch.com/docs/"><img src="https://img.shields.io/badge/Docs-kopi--agent.nousresearch.com-FFD700?style=for-the-badge" alt="Documentación"></a>
  <a href="https://discord.gg/NousResearch"><img src="https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white" alt="Discord"></a>
  <a href="https://github.com/NousResearch/kopi-agent/blob/main/LICENSE"><img src="https://img.shields.io/badge/Licencia-MIT-green?style=for-the-badge" alt="Licencia: MIT"></a>
...
> **Nota:** En Windows nativo, Kopi funciona sin WSL — la CLI, el gateway, la TUI y las herramientas funcionan de forma nativa. Si prefieres usar WSL2, el comando de Linux/macOS de arriba también funciona allí. ¿Encontraste un error? Por favor [crea un issue](https://github.com/NousResearch/kopi-agent/issues).

Ejecuta esto en PowerShell:

```powershell
iex (irm https://kopi-agent.nousresearch.com/install.ps1)
```

El instalador se encarga de todo: uv, Python 3.11, Node.js, ripgrep, ffmpeg, **y un Git Bash portátil** (MinGit, descomprimido en `%LOCALAPPDATA%\kopi\git` — no requiere administrador, completamente aislado de cualquier instalación de Git del sistema). Kopi usa este Git Bash incluido para ejecutar comandos de shell.
...
> **Android / Termux:** La ruta manual probada está documentada en la [guía de Termux](https://kopi-agent.nousresearch.com/docs/getting-started/termux). En Termux, Kopi instala el extra `.[termux]` curado porque el extra completo `.[all]` actualmente incluye dependencias de voz incompatibles con Android.
>
...
📖 **[Documentación completa →](https://kopi-agent.nousresearch.com/docs/)**

---

## Evita la colección de claves API — Nous Portal

Kopi funciona con cualquier proveedor que quieras — eso no cambiará. Pero si prefieres no recopilar cinco claves API separadas para el modelo, búsqueda web, generación de imágenes, TTS y un navegador en la nube, **[Nous Portal](https://portal.nousresearch.com)** las cubre todas bajo una sola suscripción:
...
Esto te autentica vía OAuth, establece Nous como tu proveedor y activa el Tool Gateway. Comprueba qué está conectado en cualquier momento con `kopi portal info`. Detalles completos en la [página de documentación del Tool Gateway](https://kopi-agent.nousresearch.com/docs/user-guide/features/tool-gateway).
...
Kopi tiene dos puntos de entrada: inicia la interfaz de terminal con `kopi`, o ejecuta el gateway y habla con él desde Telegram, Discord, Slack, WhatsApp, Signal o Email. Una vez en una conversación, muchos comandos de barra son compartidos entre ambas interfaces.
...
Para las listas de comandos completas, consulta la [guía de CLI](https://kopi-agent.nousresearch.com/docs/user-guide/cli) y la [guía del Gateway de Mensajería](https://kopi-agent.nousresearch.com/docs/user-guide/messaging).

---

## Documentación

Toda la documentación está en **[kopi-agent.nousresearch.com/docs](https://kopi-agent.nousresearch.com/docs/)**:

| Sección                                                                                             | Contenido                                                    |
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [Inicio rápido](https://kopi-agent.nousresearch.com/docs/getting-started/quickstart)              | Instalar → configurar → primera conversación en 2 minutos   |
| [Uso de CLI](https://kopi-agent.nousresearch.com/docs/user-guide/cli)                             | Comandos, atajos de teclado, personalidades, sesiones        |
| [Configuración](https://kopi-agent.nousresearch.com/docs/user-guide/configuration)               | Archivo de configuración, proveedores, modelos, todas las opciones |
| [Gateway de Mensajería](https://kopi-agent.nousresearch.com/docs/user-guide/messaging)           | Telegram, Discord, Slack, WhatsApp, Signal, Home Assistant   |
| [Seguridad](https://kopi-agent.nousresearch.com/docs/user-guide/security)                        | Aprobación de comandos, emparejamiento por DM, aislamiento en contenedor |
| [Herramientas y Toolsets](https://kopi-agent.nousresearch.com/docs/user-guide/features/tools)   | Más de 40 herramientas, sistema de toolsets, backends de terminal |
| [Sistema de Habilidades](https://kopi-agent.nousresearch.com/docs/user-guide/features/skills)   | Memoria procedimental, Skills Hub, creación de habilidades   |
| [Memoria](https://kopi-agent.nousresearch.com/docs/user-guide/features/memory)                   | Memoria persistente, perfiles de usuario, mejores prácticas  |
| [Integración MCP](https://kopi-agent.nousresearch.com/docs/user-guide/features/mcp)              | Conecta cualquier servidor MCP para capacidades extendidas   |
| [Programación Cron](https://kopi-agent.nousresearch.com/docs/user-guide/features/cron)           | Tareas programadas con entrega a plataforma                  |
| [Archivos de Contexto](https://kopi-agent.nousresearch.com/docs/user-guide/features/context-files) | Contexto de proyecto que da forma a cada conversación      |
| [Arquitectura](https://kopi-agent.nousresearch.com/docs/developer-guide/architecture)            | Estructura del proyecto, bucle del agente, clases principales |
| [Contribuir](https://kopi-agent.nousresearch.com/docs/developer-guide/contributing)              | Configuración de desarrollo, proceso de PR, estilo de código |
| [Referencia de CLI](https://kopi-agent.nousresearch.com/docs/reference/cli-commands)             | Todos los comandos y flags                                   |
| [Variables de Entorno](https://kopi-agent.nousresearch.com/docs/reference/environment-variables) | Referencia completa de variables de entorno                  |

---

## Migración desde OpenClaw

Si vienes de OpenClaw, Kopi puede importar automáticamente tu configuración, memorias, habilidades y claves API.
...
Inicio rápido para colaboradores — clona y comienza con `setup-kopi.sh`:

```bash
git clone https://github.com/NousResearch/kopi-agent.git
cd kopi-agent
./setup-kopi.sh     # instala uv, crea venv, instala .[all], enlaza ~/.local/bin/kopi
...
- 🐛 [Issues](https://github.com/NousResearch/kopi-agent/issues)
- 🔌 [computer-use-linux](https://github.com/avifenesh/computer-use-linux) — Servidor MCP de control de escritorio Linux para Kopi y otros hosts MCP, con árboles de accesibilidad AT-SPI, entrada Wayland/X11, capturas de pantalla y targeting de ventanas del compositor.
- 🔌 [KopiClaw](https://github.com/AaronWong1999/kopiclaw) — Puente WeChat comunitario: Ejecuta Kopi Agent y OpenClaw en la misma cuenta de WeChat.
