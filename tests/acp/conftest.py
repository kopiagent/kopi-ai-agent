...
Keeps the ACP server tests offline: ``KopiACPAgent._build_model_state``
calls ``kopi_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import kopi_cli.inventory as inventory
