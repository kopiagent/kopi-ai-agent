...
class TestLoadGatewayConfigForRunner:
    ...
    def test_scoped_reload_picks_up_default_profile_token(self, tmp_path, monkeypatch):
        ...
        monkeypatch.delenv("TELEGRAM_BOT_TOKEN", raising=False)
        # Point both kopi_constants and gateway.run at our temp home.
        monkeypatch.setattr(hc, "get_kopi_home", lambda: home)
        monkeypatch.setattr(run_mod, "get_kopi_home", lambda: home)
        monkeypatch.setattr(run_mod, "_kopi_home", home)
