...
class TestNodeToolRunnable:
    """node_tool_runnable() rejects broken Kopi-managed npm/node wrappers."""
...
class TestResolvePerModelReasoningEffort:
    ...
    def test_exact_match(self):
        ...
        from kopi_constants import resolve_per_model_reasoning_effort
...
class TestReasoningOverridesDefaultConfig:
    ...
    def test_load_config_preserves_user_reasoning_overrides(self, tmp_path, monkeypatch):
        ...
        import yaml
        from kopi_cli.config import load_config, get_config_path
...
class TestWslPathTranslation:
    ...
    def test_windows_drive_to_wsl_mount(self):
        assert kopi_constants.windows_path_to_wsl(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert kopi_constants.windows_path_to_wsl("C:/Users/alex") == "/mnt/c/Users/alex"
        assert kopi_constants.windows_path_to_wsl("D:\\") == "/mnt/d/"

    def test_windows_drive_ignores_non_drive_paths(self):
        assert kopi_constants.windows_path_to_wsl("/home/alex") is None
        assert kopi_constants.windows_path_to_wsl("relative\\dir") is None

    def test_wsl_unc_to_posix_both_spellings(self):
        assert kopi_constants.wsl_unc_path_to_posix(r"\\wsl.localhost\Ubuntu\home\alex") == "/home/alex"
        assert kopi_constants.wsl_unc_path_to_posix(r"\\wsl$\Ubuntu\home\alex") == "/home/alex"
        # Forward-slash spelling and distro root.
        assert kopi_constants.wsl_unc_path_to_posix("//wsl.localhost/Debian/srv/app") == "/srv/app"
        assert kopi_constants.wsl_unc_path_to_posix("\\\\wsl.localhost\\Ubuntu\\") == "/"

    def test_wsl_unc_ignores_non_unc_paths(self):
        assert kopi_constants.wsl_unc_path_to_posix(r"C:\Users\alex") is None
        assert kopi_constants.wsl_unc_path_to_posix("/home/alex") is None

    def test_translate_is_noop_off_wsl(self, monkeypatch):
        monkeypatch.setattr(kopi_constants, "is_wsl", lambda: False)
        assert kopi_constants.translate_cwd_for_wsl_backend(r"C:\Users\alex") == r"C:\Users\alex"

    def test_translate_maps_windows_and_unc_on_wsl(self, monkeypatch):
        monkeypatch.setattr(kopi_constants, "is_wsl", lambda: True)
        assert kopi_constants.translate_cwd_for_wsl_backend(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert kopi_constants.translate_cwd_for_wsl_backend(r"\\wsl.localhost\Ubuntu\home\alex") == "/home/alex"
        # Already-POSIX paths pass through untouched.
        assert kopi_constants.translate_cwd_for_wsl_backend("/home/alex") == "/home/alex"
