"""Tests for `kopi secrets bitwarden token` / `kopi secrets onepassword token`.
...
from kopi_cli import onepassword_secrets_cli as op_cli
from kopi_cli import secrets_cli as bw_cli
