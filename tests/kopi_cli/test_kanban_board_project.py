...
A kanban board can be scoped to a first-class Kopi project so every task on
...
def fresh_home(tmp_path, monkeypatch):
    ...
    for var in ("KOPI_KANBAN_DB", "KOPI_KANBAN_WORKSPACES_ROOT", "KOPI_KANBAN_HOME", "KOPI_KANBAN_BOARD"):
