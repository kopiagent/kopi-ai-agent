...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (kopi_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_kopi_overlays():
    """kopi_cli.providers.get_provider("vertex") backs
