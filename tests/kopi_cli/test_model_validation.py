...
class TestProviderModelIds:
    ...
    def test_anthropic_provider_uses_configured_base_url_for_live_catalog(self):
        ...
        with patch(
            ...
            "kopi_cli.models._urlopen_model_catalog_request",
            return_value=_Resp(),
        ) as mock_urlopen:
...
class TestFetchApiModels:
    ...
    def test_returns_none_on_network_error(self):
        with patch("kopi_cli.models._urlopen_model_catalog_request", side_effect=Exception("timeout")):
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch("kopi_cli.models._urlopen_model_catalog_request", side_effect=_fake_urlopen):
    ...
    def test_probe_api_models_uses_copilot_catalog(self):
        ...
        with patch("kopi_cli.models._urlopen_model_catalog_request", return_value=_Resp()) as mock_urlopen:
    ...
    def test_fetch_github_model_catalog_filters_non_chat_models(self):
        ...
        with patch("kopi_cli.models._urlopen_model_catalog_request", return_value=_Resp()):
...
class TestValidateApiFallback:
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("kopi_cli.models._urlopen_model_catalog_request", return_value=mock_resp):
    ...
    def test_fetch_lmstudio_models_normalizes_native_api_base_url(self):
        ...
        with patch("kopi_cli.models._urlopen_model_catalog_request", return_value=mock_resp) as mock_urlopen:
    ...
    def test_fetch_lmstudio_models_raises_auth_error_on_401(self):
        ...
        with patch("kopi_cli.models._urlopen_model_catalog_request", side_effect=http_error):
...
class TestProbeApiModelsUserAgent:
    ...
    def test_probe_sends_client_context_to_gemini(self):
        from unittest.mock import patch
        from kopi_cli.models import _KOPI_VERSION
        ...
        req = mock_urlopen.call_args[0][0]
        assert req.get_header("X-goog-api-client") == f"kopi-ai-agent/{_KOPI_VERSION}"
