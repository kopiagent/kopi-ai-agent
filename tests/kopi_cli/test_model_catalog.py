...
def _valid_manifest() -> dict:
    return {
        ...
        "providers": {
            ...
            "nous": {
                "metadata": {"display_name": "Kopi Official"},
                "models": [
...
class TestFallbackChain:
    ...
    FALLBACK = (
        "https://raw.githubusercontent.com/NousResearch/kopi-ai-agent"
...
class TestDefaultModelFromCache:
    ...
    def test_shipped_manifest_labels_glm52_default(self, isolated_home):
        ...
        import kopi_cli.model_catalog as model_catalog
        from kopi_cli.models import PREFERRED_SILENT_DEFAULT_MODEL
