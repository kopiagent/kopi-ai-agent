...
LEGACY_SCHEMA_PATH = SCHEMA_PATH.with_name("kopi.shared_metrics.v1.schema.json")
...
def test_model_call_counter_survives_restart_and_exports_only_new_deltas(tmp_path):
    ...
    assert first_package["schema_version"] == "kopi.shared_metrics.v2"
...
def test_package_schema_matches_the_model_call_contract():
    ...
    assert schema["properties"]["schema_version"]["const"] == "kopi.shared_metrics.v2"
...
def test_v1_package_schema_retains_the_legacy_model_contract():
    ...
    assert schema["properties"]["schema_version"]["const"] == "kopi.shared_metrics.v1"
...
def test_auxiliary_logical_scope_projects_one_normalized_terminal_route():
    event = SimpleNamespace(
        ...
        metadata={
            ...
            "kopi.call_role": "auxiliary:compression",
        },
    )
    ...
    event.metadata["kopi.call_role"] = "primary"
...
def test_tool_subscriber_contract_accepts_only_bounded_events():
    terminal = SimpleNamespace(
        ...
        name="kopi.tool_call",
        scope_category="end",
        metadata={"kopi.metrics.schema_version": "kopi.metrics.event.v2"},
        data={
