"""Regression: ``kopi update`` should take a managed checkout off autocrlf=true.
...
``kopi update`` has to repair them.
...
from kopi_cli.update_cmd import _normalize_managed_eol
