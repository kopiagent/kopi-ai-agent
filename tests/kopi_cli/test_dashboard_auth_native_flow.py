...
Run: pytest tests/kopi_cli/test_dashboard_auth_native_flow.py
"""
...
from kopi_cli.dashboard_auth import native_flow
from kopi_cli.dashboard_auth.base import Session
...
def _walk_native_login(client, *, redirect_uri, challenge, state="cli-state"):
    ...
    assert "kopi_session_at" not in set_cookie, (
