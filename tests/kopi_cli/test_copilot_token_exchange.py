...
class TestExchangeFailureFastPath:
    ...
    def test_transient_failure_still_retries_then_caches(self, mock_urlopen, mock_sleep):
        import kopi_cli.copilot_auth as mod
        from kopi_cli.copilot_auth import exchange_copilot_token, _token_fingerprint
    ...
    def test_evict_clears_negative_cache(self):
        import kopi_cli.copilot_auth as mod
        from kopi_cli.copilot_auth import evict_cached_exchanged_token, _token_fingerprint
