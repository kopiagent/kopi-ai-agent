...
host-side Kopi, not an update to the running container, so the message
...
@patch("kopi_cli.config.is_managed", return_value=False)
@patch("kopi_cli.config.detect_install_method", return_value="nix")
@patch("kopi_cli.main._cmd_update_impl")
