...
class TestRequireConfirmedUpdate:
    """`kopi update` passes require_confirmed_update=True: the full
    ...
    Explicit `kopi computer-use install --upgrade` keeps the old
    ...
    def test_explicit_upgrade_still_falls_through_on_indeterminate(self):
        # `kopi computer-use install --upgrade` (default flag): the old
...
class TestUpdateCheckTimeoutDefaults:
    ...
    full reinstall fall-through during `kopi update`.
    """
