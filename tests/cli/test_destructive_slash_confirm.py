...
def test_split_destructive_skip_recognized_tokens():
    ...
    assert KopiCLI._split_destructive_skip("/reset now") == ("", True)
    assert KopiCLI._split_destructive_skip("/clear --yes") == ("", True)
    assert KopiCLI._split_destructive_skip("/undo -y") == ("", True)
...
def test_split_destructive_skip_strips_command_word():
    ...
    assert KopiCLI._split_destructive_skip("/new My title") == ("My title", False)
    assert KopiCLI._split_destructive_skip("/new --yes My title") == ("My title", True)
...
def test_split_destructive_skip_case_insensitive():
    ...
    assert KopiCLI._split_destructive_skip("/new NOW") == ("", True)
    # Substring match must NOT trigger — "Now-Title" is a literal title token.
    assert KopiCLI._split_destructive_skip("/new Now-Title") == ("Now-Title", False)
...
def test_split_destructive_skip_handles_empty_and_none():
    ...
    assert KopiCLI._split_destructive_skip(None) == ("", False)
    assert KopiCLI._split_destructive_skip("") == ("", False)
    assert KopiCLI._split_destructive_skip("   ") == ("", False)
...
def test_confirm_destructive_slash_now_skips_modal():
    ...
    self_._split_destructive_skip = KopiCLI._split_destructive_skip  # classmethod
...
def test_confirm_destructive_slash_yes_flag_skips_modal():
    ...
    self_._split_destructive_skip = KopiCLI._split_destructive_skip
