...
class TestTerminalIntegration:
    ...
    def test_passthrough_cannot_override_internal_dynamic_secret(self):
        """A skill must NOT be able to register dynamically-named Kopi
    ...
    def test_provider_blocklist_import_failure_fails_closed(self, monkeypatch):
        ...
        otherwise a skill could tunnel a Kopi credential into the
        ...
        it out of the child env. A non-Kopi key is also rejected here (the
