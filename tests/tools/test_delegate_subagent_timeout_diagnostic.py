...
class TestRunSingleChildTimeoutDump:
    ...
    def test_timeout_result_carries_structured_metadata(self, kopi_home, monkeypatch):
    ...
    def test_timeout_phase_after_llm_calls(self, kopi_home, monkeypatch):
        child = _StubChild(api_call_count=5, hang_seconds=10.0)
        result = self._invoke_with_short_timeout(child, monkeypatch)
    ...
    def test_non_timeout_error_has_null_timeout_metadata(self, kopi_home, monkeypatch):
