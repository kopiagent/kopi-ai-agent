...
class TestBrowserConsole:
    ...
    def test_restrict_evaluate_reads_browser_config(self):
        ...
        with patch("kopi_cli.config.read_raw_config", return_value={"browser": {"restrict_evaluate": "true"}}):
            assert _restrict_browser_evaluate() is True
        with patch("kopi_cli.config.read_raw_config", return_value={"browser": {"restrict_evaluate": False}}):
