...
Under a gateway (Telegram, Discord, Slack, ...) Kopi passes the
...
class TestCrossPlatformMemoryUnification:
    """The same physical user talking to Kopi via Telegram AND Discord
...
class TestProfilePeerUniqueness:
    """Each Kopi profile can pin to its own unique peerName.
