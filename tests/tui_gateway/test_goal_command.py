...
@pytest.fixture()
def server(kopi_home, monkeypatch):
    ...
    # Pin config resolution to the isolated KOPI_HOME. Sibling test
    ...
    # module-level ``_kopi_home = get_kopi_home()`` snapshot freezes
    ...
    monkeypatch.setattr(mod, "_kopi_home", kopi_home)
