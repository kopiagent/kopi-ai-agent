...
between ``KOPI_BACKEND_READY`` and the first prompt. Three fixes:
...
class TestCopilotAuthSkipsGhCli:
    ...
    def test_invalid_env_var_skips_gh_cli(self, monkeypatch):
        ...
        with patch("kopi_cli.copilot_auth._try_gh_cli_token") as mock_cli:
    ...
    def test_no_env_vars_falls_back_to_gh_cli(self, monkeypatch):
        ...
        with patch(
            "kopi_cli.copilot_auth._try_gh_cli_token",
