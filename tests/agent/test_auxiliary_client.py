...
class TestResolveTaskProviderModel:
    ...
    def test_config_provider_moa_falls_back_to_default_preset(self, monkeypatch):
        ...
        preset = {
            "aggregator": {"provider": "nous", "model": "kopi-4-405b"},
        }
        ...
        monkeypatch.setattr("kopi_cli.moa_config.resolve_moa_preset", fake_resolve)
        monkeypatch.setattr("kopi_cli.config.load_config", lambda: {"moa": {}})
...
class TestAuxiliaryAuthRefreshRetry:
    ...
    def test_resolve_provider_client_vertex_builds_client_from_minted_token(self):
        ...
        the PROVIDER_REGISTRY lookup (a plain KOPI_OVERLAYS-only fix would
