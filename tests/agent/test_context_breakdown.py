...
def test_compute_context_details_maps_bytes_to_tokens():
    ...
    with patch("agent.system_prompt.build_system_prompt_parts", return_value=parts), \
         patch("kopi_cli.prompt_size._compute_skills_breakdown", return_value=fake_skills), \
         patch("kopi_cli.prompt_size._compute_toolsets_breakdown", return_value=fake_toolsets):
