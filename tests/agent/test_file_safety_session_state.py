...
manipulation. Kopi keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point KOPI_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_kopi_home /
    get_default_kopi_root) instead of monkeypatching private helpers —
    ...
    KOPI_HOME=<root>/profiles/<name> makes get_default_kopi_root()
