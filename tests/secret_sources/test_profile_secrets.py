...
def _apply(secrets, cfg_extra=None, home=Path("/tmp/x/.kopi"), env=None):
...
PROFILE_HOME = Path("/home/u/.kopi/profiles/milla")
...
def test_hyphenated_profile_name_matches_underscore_suffix():
    _, env = _apply(
        ...
        home=Path("/home/u/.kopi/profiles/my-bot"),
    )
