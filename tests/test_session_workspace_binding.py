"""Session <-> workspace grouping key (kopi_state.workspace_key).

The key is what `kopi sessions list --workspace` groups/filters on. It is a
...
from kopi_state import workspace_key
