...
class TestEnsureClientReloadsEnv:
    ...
    def test_handle_tool_call_after_reload_to_local_endpoint_starts_runtime_recovery(
        ...
        known_kopi_env = set(kopi_config.OPTIONAL_ENV_VARS) | kopi_config._EXTRA_ENV_KEYS
        ...
        for key in known_kopi_env | openviking_tenant_env:
            monkeypatch.delenv(key, raising=False)
        ...
        assert kopi_config.reload_env() >= 1
