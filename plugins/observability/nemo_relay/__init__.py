...
class _Runtime:
    ...
    def _run_managed_with_downstream_preservation(
        ...
        *,
        ...
        # execution so Kopi retry classification still sees it. The LLM and tool
...
def _original_downstream_error(exc: Exception) -> BaseException:
    # Kopi wraps downstream execution failures in a local/private exception
...
def _is_relay_wrapped_callback_error(exc: Exception, callback_error: Exception | None) -> bool:
    ...
    # leading ``internal error:`` shape entirely, this returns False and Kopi
