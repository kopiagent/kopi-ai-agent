...
(function () {
  ...
  const DOCS_URL = "https://kopi-agent.nousresearch.com/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://kopi-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial";
  ...
  // centered modal reusing the kopi-kanban-dialog chrome so the form is
  ...
  function InlineCreate(props) {
    ...
    return h("div", {
      ...
      h("form", {
        className: "kopi-kanban-dialog kopi-kanban-create-dialog",
  ...
  function TaskDrawer(props) {
    ...
    return h("div", { className: "kopi-kanban-drawer-shade", onClick: props.onClose },
      h("div", {
        ...
        data ? h("div", { className: "kopi-kanban-drawer-comment-foot" },
          h("div", {
            className: "kopi-kanban-comment-hint text-xs text-muted-foreground",
          ...
          h("div", { className: "kopi-kanban-drawer-comment-row" },
            h(Input, {
              value: newComment,
    ...
    return h("div", { className: "kopi-kanban-drawer-body" },
      ...
      (function () {
        ...
        if (finalResult) {
          ...
          return h("div", { className: "kopi-kanban-section" },
            h("div", { className: "kopi-kanban-section-head" }, label),
        ...
        if (isDone && isParent) {
          return h("div", { className: "kopi-kanban-section" },
            ...
            h("div", { className: "kopi-kanban-done-no-result kopi-kanban-done-parent-note" },
        ...
        if (isDone) {
          return h("div", { className: "kopi-kanban-section" },
            h("div", { className: "kopi-kanban-section-head" }, tx(i18n, "result", "Result")),
            h("div", { className: "kopi-kanban-done-no-result" },
      ...
      childResults.length > 0 ? h("div", { className: "kopi-kanban-section" },
        h("div", { className: "kopi-kanban-section-head" },
        ...
        childResults.map(function (child) {
          ...
          return h("div", { key: child.id, className: "kopi-kanban-comment" },
            h("div", { className: "kopi-kanban-comment-head" },
              h("span", { className: "kopi-kanban-comment-author" },
                `${child.id} · ${child.title || tx(i18n, "untitled", "(untitled)")}`),
              h(Badge, { variant: "outline" }, child.status),
              h("button", {
                type: "button",
                className: "kopi-kanban-diag-action-btn",
  ...
  function ModelEditor(props) {
    ...
    if (!editing) {
      return h("div", { className: "kopi-kanban-meta-row" },
        h("span", { className: "kopi-kanban-meta-label" }, tx(t, "model", "Model")),
        h("span", {
          className: cn(
            "kopi-kanban-meta-value kopi-kanban-editable",
    ...
    return h("div", { className: "kopi-kanban-meta-row" },
      h("span", { className: "kopi-kanban-meta-label" }, tx(t, "model", "Model")),
      loading
        ? h("span", { className: "kopi-kanban-meta-value text-muted-foreground" },
