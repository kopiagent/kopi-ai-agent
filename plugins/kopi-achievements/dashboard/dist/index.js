(function () {
  ...
  function api(path, options) {
    ...
    // BOTH dashboard modes: loopback (X-Kopi-Session-Token header) and
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("KOPI AGENT  ·  kopi-agent.nousresearch.com", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in Kopi Agent ☤", {
        tier_part: tierPart,
        name: achievement.name,
      });
      return tmpl + "\n\n@NousResearch · https://kopi-agent.nousresearch.com";
    }
