...
def _check_local_runtime() -> tuple[bool, str | None]:
    ...
    healthy and ``kopi memory status`` would stay green while the daemon
...
def _load_simple_env(path) -> dict[str, str]:
    ...
    values: dict[str, str] = {}
    # utf-8-sig, not plain utf-8: this is also used on the Kopi .env during
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._retain_context = "conversation between Kopi Agent and the User"
    ...
    def post_setup(self, kopi_home: str, config: dict) -> None:
        ...
        # data-volume target instead of writing to /opt/kopi (NS-605).
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "retain_context", "description": "Context label for retained memories", "default": "conversation between Kopi Agent and the User"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        try:
            ...
            if Version(installed) < Version(_MIN_CLIENT_VERSION):
                ...
                # durable data-volume target instead of /opt/kopi (NS-605).
                from tools.lazy_deps import install_specs
        ...
        self._retain_context = self._config.get("retain_context", "conversation between Kopi Agent and the User")
        ...
        if self._mode == "local_embedded":
            ...
            if hasattr(os, "geteuid") and os.geteuid() == 0:
                msg = (
                    ...
                    "memory daemon. Run Kopi as a non-root user, or switch "
