...
# When the user hasn't picked a reasoning effort, Kopi passes
...
# ON at this effort — matching the "medium (default)" that Kopi' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Kopi' effort vocabulary onto Solar's accepted set. xhigh/max/
