"""
A2A (Agent-to-Agent) plugin for Kopi Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Kopi as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`kopi gateway setup` flow for A2A."""
    ...
    print_info("Expose Kopi as an A2A-discoverable agent and call other A2A agents.")
