"""SimpleX Chat platform adapter (Kopi plugin).
...
This adapter ships as a Kopi platform plugin under
``plugins/platforms/simplex/``. The Kopi plugin loader scans the
...
# Imported at module top because they're stdlib-only inside Kopi — no
