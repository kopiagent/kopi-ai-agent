...
class FeishuAdapter(BasePlatformAdapter):
    ...
    async def _connect_websocket(self) -> None:
        ...
        self._ws_client = FeishuWSClient(
            ...
            # See https://github.com/NousResearch/kopi-ai-agent/issues/50656
...
async def _standalone_send(
    ...
    *,
    ...
    """
    if not FEISHU_AVAILABLE:
        return {"error": "Feishu dependencies not installed. Run `kopi setup` to install Feishu support."}
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `kopi setup` to install Feishu support.",
