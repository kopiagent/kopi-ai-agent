...
# trigger its own recovery path. Refs: NousResearch/kopi-ai-agent#59614
...
# _UPDATER_STOP_TIMEOUT. Refs: NousResearch/kopi-ai-agent#66377
_DRAIN_TIMEOUT = 15.0
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    # older PTB/clients. Streaming edits stay on Kopi' existing MarkdownV2
    ...
    def _has_telegram_desktop_details_math_crash_shape(self, content: str) -> bool:
        ...
        Kopi must skip rich delivery up front and use the legacy MarkdownV2
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: NousResearch/kopi-ai-agent#58270
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "To recover: ensure no other Kopi or OpenClaw instance is running "
    ...
    async def _run_post_connect_housekeeping(self) -> None:
        ...
        try:
            ...
            try:
                ...
                # payload size limit (~4KB total).  Kopi defaults to 60 to
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            # readable by the Kopi process (shared mount, same machine, etc.).
                ...
                try:
                    ...
                    if asyncio.get_running_loop().time() >= _total_deadline:
                        raise OSError(
                            ...
                            f"or set KOPI_TELEGRAM_HTTP_CONNECT_TIMEOUT / "
                            f"KOPI_TELEGRAM_INIT_TIMEOUT to a lower value."
                        )
                    logger.warning(
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several Kopi bot profiles. A message like
    ...
    def _is_own_message(self, message: Message) -> bool:
        ...
        counted as incoming unread messages in the Kopi inbox.
        """
        if not self._bot:
            return False
    ...
    def _should_process_message(self, message: Message, *, is_command: bool = False) -> bool:
        ...
        # unread in the Kopi inbox (#52363).
        #
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `kopi setup` to install Telegram support.",
