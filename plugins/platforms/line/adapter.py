"""
LINE Messaging API platform adapter for Kopi Agent.
...
to Kopi Agent. It deliberately ports the *strongest* idea from each into
...
def interactive_setup() -> None:
    ...
    try:
        from kopi_cli.config import get_env_value as _get_env, save_env_value as _set_env
    except ImportError:
