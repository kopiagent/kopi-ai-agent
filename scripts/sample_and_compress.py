...
DEFAULT_DATASETS = [
    ...
    "NousResearch/kopi-ai-agent-megascience-sft1",
    "NousResearch/Kopi-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Kopi-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-kopi-ai-agent"
]
