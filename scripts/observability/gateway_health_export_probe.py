...
def main() -> None:
    ...
    kopi_home = Path(tempfile.mkdtemp(prefix="kopi-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "kopi-gateway-smoke",
    ...
    print(json.dumps({"kopi_home": str(kopi_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
