"""Core NeMo Relay adapter for Kopi tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Kopi tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Kopi Relay tool execution cannot run on an active event-loop thread"
    )
