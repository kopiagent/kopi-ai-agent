...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level kopi_cli import risks
...
def auto_title_session(
    ...
    post-``kopi update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Kopi process): %s",
            e,
        )
