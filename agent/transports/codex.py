...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Kopi's web-provider config and
        ...
        # native search engine for xAI sessions instead of Kopi's
        # configured web provider (Tavily/etc.), and those results bypass
        # Kopi's tool-trace / citation plumbing (they arrive baked into the
