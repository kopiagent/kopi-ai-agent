...
def computer_use_guidance(platform_name: Optional[str] = None) -> str:
    ...
    return (
        ...
        "when Kopi has none; explicit Kopi YOLO uses a private unrestricted "
...
def build_context_files_prompt(
    ...
    # Never let a FALLBACK-picked directory inside the Kopi install/source
    ...
    # explicitly configured cwd is honored verbatim — the Kopi tree is a
    ...
    # their launch dir IS the user's shell cwd (developing Kopi in-tree).
    ...
    if (
        ...
        logger.warning(
            ...
            "fell back to the Kopi install tree (%s) — set terminal.cwd to "
