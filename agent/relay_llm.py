"""Core NeMo Relay adapters for physical Kopi provider attempts."""
...
def execute_current(
    ...
    *,
    ...
    """Run a provider attempt under the inherited Kopi turn when present."""
...
def stream_current(
    ...
    *,
    ...
    """Run a provider stream under the inherited Kopi turn when present.
...
class ManagedLlmStream(Iterator[Any]):
    """Drive Relay's async stream from Kopi's provider worker thread."""
...
class AnthropicStreamAccumulator:
    ...
    def response(self, base: Any = None) -> Any:
        """Return the attribute-shaped response consumed by Kopi."""
