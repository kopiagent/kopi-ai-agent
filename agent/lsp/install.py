...
appropriate.  All installs go to a Kopi-owned bin staging dir,
...
def _install_npm(
    ...
    """
    # Managed npm first: $KOPI_HOME/node is not on an arbitrary process's
    # PATH, so a bare which() misses the Node that Kopi installed and
