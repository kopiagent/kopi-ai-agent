...
# kopi_cli.mcp_startup.start_background_mcp_discovery can actually fire for
...
def wait_for_mcp_discovery(timeout: "float | None" = None) -> None:
    ...
    # kopi_cli.mcp_startup.wait_for_mcp_discovery directly, and delegating
...
def main():
    ...
    if _has_mcp_servers:
        # Spawn via the shared owner in kopi_cli.mcp_startup instead of
