...
It builds and launches the GUI against your existing install — same config, keys, sessions, and skills. On first launch Kopi walks you through picking a provider and model; nothing else to configure.
