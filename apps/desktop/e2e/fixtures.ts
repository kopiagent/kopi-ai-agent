 ...
 */
export function writeMockProviderConfig(kopiHome: string, mockUrl: string, extraConfig?: string): void {
...
export async function setupMockBackend(options: MockBackendOptions = {}): Promise<MockBackendFixture> {
  ...
  writeMockProviderConfig(sandbox.kopiHome, mock.url, options.extraDisplayConfig)
