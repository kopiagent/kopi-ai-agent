#!/usr/bin/env python3
"""Seed a Kopi state.db with a session exported from a real conversation.
...
# Add the repo root to sys.path so we can import kopi_state.
# The script is invoked from apps/desktop/e2e/ — repo root is ../../..
repo_root = Path(__file__).resolve().parents[3]
sys.path.insert(0, str(repo_root))

from kopi_state import SessionDB  # noqa: E402
