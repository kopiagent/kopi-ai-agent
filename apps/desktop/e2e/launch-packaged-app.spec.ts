...
/**
 * E2E smoke tests for the packaged Kopi desktop app.
 *
 ...
 * (credential stripping, isolated KOPI_HOME + userData, unique app name).
 *
...
test('window opens with the Kopi title', async () => {
