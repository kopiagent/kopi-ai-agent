 ...
 * `src/plugins/` with a `plugin.tsx` that default-exports a `KopiPlugin` is
 ...
 *
 * The ONLY import surface is `@kopi/plugin-sdk` (lint-enforced) — the
