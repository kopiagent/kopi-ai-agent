...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@kopi/plugin-sdk'
...
/** First-class Kopi projects, for scoping a board's default workspace. */
