 ...
 * `<kopi home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'kopi.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'kopi.desktop.disabledPlugins.v1'
