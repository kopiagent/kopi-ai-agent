import type { GatewayWsUrlResult } from '@kopi/shared'
...
declare global {
  interface Window {
    kopiDesktop: {
      ...
      // Local Desktop runtime-plugin root (<KOPI_HOME>/desktop-plugins),
