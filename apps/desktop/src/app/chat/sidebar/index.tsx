...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('kopi:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('kopi:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Kopi to
