...
export function useGatewayRequest() {
  ...
  const gatewayRef = useRef<KopiGateway | null>(null)
  ...
  const reconnectingRef = useRef<Promise<KopiGateway | null> | null>(null)
  ...
  useEffect(
    () =>
      $gateway.subscribe(gateway => {
        gatewayRef.current = gateway as KopiGateway | null
      }),
    []
  )
