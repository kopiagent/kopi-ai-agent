...
function ConnectedProviderRow({
  ...
  // Kopi can clear this provider's creds via the API.
  const canDisconnect = provider.disconnectable ?? provider.flow !== 'external'
  // External (CLI-managed) provider Kopi can't clear via the API, but ships a
...
export function ProvidersSettings({
  ...
  // Kopi never deletes creds another tool owns behind a silent API call.
