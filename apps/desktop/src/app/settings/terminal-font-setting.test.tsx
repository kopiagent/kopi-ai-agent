...
vi.mock('@/kopi', () => ({
  saveKopiConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setKopiConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useKopiConfigRecord: () => ({ data: mocks.loadedConfig })
}))
