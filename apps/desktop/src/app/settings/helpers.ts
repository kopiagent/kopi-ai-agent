...
import type { ConfigFieldSchema, KopiConfigRecord, ToolsetInfo } from '@/types/kopi'
...
export function getNested(obj: KopiConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: KopiConfigRecord, path: string, value: unknown): KopiConfigRecord {
...
function personalityOptions(config: KopiConfigRecord): string[] {
...
function commandProviderNames(config: KopiConfigRecord, section: 'tts' | 'stt'): string[] {
