...
import { saveKopiConfig } from '@/kopi'
...
function fontFamilyFromConfig(config: KopiConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useKopiConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<KopiConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setKopiConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="kopi-terminal-font-families"
          ...
          <datalist id="kopi-terminal-font-families">
