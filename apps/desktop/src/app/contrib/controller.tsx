...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <kopi home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('kopi:open-keybinds'))
    } satisfies PaletteContribution
  }
])
...
const $logsOpen = persistentAtom('kopi.desktop.logsOpen', false, Codecs.bool)
