...
import { getCronJobs, getSessionMessages, listAllProfileSessions, type SessionInfo, triggerCronJob } from '../kopi'
...
export function DesktopController() {
  ...
  // "Hey Kopi": handle the wake event on the canonical onEvent pipeline (the
  ...
  // "Hey Kopi" wake word: arm the server-side detector for this surface
