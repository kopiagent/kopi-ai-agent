...
const TAKEOVER_KEY = 'kopi.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Kopi can't clear via the API — the user
 *  sees exactly what runs instead of Kopi silently deleting their creds. */
