import type { KopiReviewFile } from '@/global'
...
export function buildReviewFlatList(files: KopiReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: KopiReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
