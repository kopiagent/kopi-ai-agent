...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/kopi-ai-agent')).toBe('~/www/kopi-ai-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/kopi-ai-agent')).toBe('kopi-ai-agent')
    expect(pathLeaf('~/www/kopi-ai-agent')).toBe('kopi-ai-agent')
