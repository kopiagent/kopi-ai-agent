...
import { type BillingBlock, skillInvocationText } from '@kopi/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/kopi'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @kopi/shared BillingBlock).
