...
/** Kopi' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (kopi_constants.py). `none` is not a level: it's
...
/** Kopi' built-in level when neither the surface nor the profile config
