import type { ConnectionState } from '@kopi/shared'
...
const COMPOSER_MODEL_SOURCE_KEY = 'kopi.desktop.composer.model-source'
...
const LAST_ROUTE_KEY = 'kopi.desktop.lastRoute'
...
// until config loads, and re-seeded on every profile switch by useKopiConfig.
