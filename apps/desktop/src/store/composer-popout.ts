...
const POPOUT_STORAGE_KEY = 'kopi.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'kopi.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'kopi.desktop.composerPopout.position'
