...
const STORAGE_KEY = 'kopi:native-notifications'
...
// "Backgrounded" = the user isn't on Kopi. `document.hidden` only flips when
 ...
 *  user is away from Kopi — the in-app toast (`host.notify`) covers the
 *  foreground case. */
