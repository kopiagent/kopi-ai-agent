 ...
 * app's bounds and stays visible while Kopi is minimized. That window carries
...
const OVERLAY_ACTIVE_KEY = 'kopi.desktop.pet-overlay-active.v1'
const OVERLAY_BOUNDS_KEY = 'kopi.desktop.pet-overlay-bounds.v1'
