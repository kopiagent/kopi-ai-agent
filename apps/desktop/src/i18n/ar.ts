...
export const ar = defineLocale({
  ...
  updates: {
    ...
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد Kopi الاتصال تلقائيا عند عودتها.',
  ...
  onboarding: {
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه Kopi إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
  ...
  preview: {
    ...
    web: {
      ...
      stillWorking:
        'لا يزال Kopi يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
