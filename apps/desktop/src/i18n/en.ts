...
export const en: Translations = {
  ...
  settings: {
    ...
    notifications: {
      ...
      kinds: {
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Kopi was in the background.'
        }
      },
    ...
    appearance: {
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Kopi can react to yours.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Kopi backend elsewhere. Per-profile overrides below.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Kopi Cloud · ${host}`,
