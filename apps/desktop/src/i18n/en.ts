...
export const en: Translations = {
  ...
  boot: {
    ready: 'Kopi Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Kopi settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingKopiDesktop: 'Starting Kopi Desktop…'
    },
    errors: {
      backgroundExited: 'Kopi background process exited.',
      backgroundExitedDuringStartup: 'Kopi background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Kopi backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Kopi Desktop.',
    ...
    native: {
      ...
      inputBody: 'Kopi is waiting for your response.',
      turnDoneTitle: 'Kopi finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Kopi defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Kopi writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Kopi is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Kopi asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Kopi was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Kopi follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Kopi is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Kopi, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Kopi checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Kopi configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Kopi.',
    ...
    gateway: {
      ...
      intro:
        'Kopi Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Kopi backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote Kopi backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Kopi Cloud',
      cloudDesc: 'Sign in once to Kopi Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Kopi Cloud',
      cloudSignIn: 'Sign in to Kopi Cloud',
      cloudSignedIn: 'Signed in to Kopi Cloud',
      cloudNeedsSignIn: 'Sign in to Kopi Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'KOPI portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Kopi Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Kopi Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Kopi Cloud',
      cloudSignedOutMessage: 'Cleared the Kopi Cloud session.',
      ...
      restartingMessage: 'Kopi Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Kopi ${version}` : ''}`,
      ...
      sshDesc:
        'Kopi is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Kopi found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Kopi runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Kopi is not installed on the remote host. Install it there (curl -fsSL https://kopi-ai-agent.nousresearch.com/install.sh | sh) or set the Kopi path.',
      sshErrPlatform:
        'Unsupported remote platform. Kopi Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Kopi on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Kopi runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Kopi at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousAuthDoneTitle: 'KOPI Proxy connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'KOPI Proxy sign-in did not complete',
  ...
  starmap: {
    ...
    emptyDesc: 'As Kopi builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Kopi to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Kopi to generate pets.',
      backgroundHint: 'You can close this — Kopi will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Kopi desktop' },
    ...
    kopiActiveSessions: (version, count) => `Kopi ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@kopi:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Kopi environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Kopi will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Kopi backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Kopi. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Kopi...',
    placeholderReconnecting: 'Reconnecting to Kopi…',
    ...
    attachUrlDesc: 'Kopi will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Kopi…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Kopi…',
    ...
    unsupportedMessage: 'This version of Kopi can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Kopi from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Kopi will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Kopi desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Kopi updater takes over in its own window and reopens Kopi automatically when it’s done. Please don’t reopen Kopi yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Kopi reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Kopi reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Kopi needs a one-time install',
    ...
    installLocalTitle: 'Install Kopi locally',
    installLocalDesc: 'Download Kopi, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Kopi Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Kopi',
    remoteSetupDesc: 'Enter your gateway URL. Kopi Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Kopi gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/kopi',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Kopi gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Kopi Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Kopi CLI or desktop instance is running. Stop any running Kopi instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Kopi Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Kopi is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Kopi…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Kopi',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Kopi at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Kopi connects automatically',
    ...
    authorizeThere: 'Authorize Kopi there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Kopi there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid KOPI subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Kopi Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Connected to Kopi Cloud at ${host} · click to manage`,
      ...
      gatewayTitle: 'Kopi inference gateway status',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Kopi will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Kopi is restarting...',
      askRestart: 'Ask Kopi to restart the server',
      lookingRestart: taskId => `Kopi is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Kopi is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Kopi finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Kopi could not restart the server.',
      stillWorking:
        'Kopi is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Kopi is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Kopi gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.kopi/config.yaml). Kopi won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Kopi needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Kopi needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Kopi Desktop to use Save Image.',
    restartToSaveImages: 'Restart Kopi Desktop to save images',
