...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshKopiPathTitle: string
      sshKopiPathDesc: string
      sshKopiPathPlaceholder: string
  ...
  commandCenter: {
    ...
    kopiActiveSessions: (version: string, count: number) => string
