...
const STORAGE_KEY = 'kopi.desktop.layoutTree.v2'

writeKey('kopi.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('kopi.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('kopi.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'kopi.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'kopi.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__KOPI_LAYOUT_TREE__ = {
    close: closeTreePane,
