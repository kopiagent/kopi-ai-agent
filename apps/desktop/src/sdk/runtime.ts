 ...
 * plugins resolve `@kopi/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __KOPI_PLUGIN_SDK__: sdk,
  __KOPI_REACT__: React,
  __KOPI_REACT_JSX__: jsxRuntime,
  __KOPI_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@kopi/plugin-sdk': shimUrl('__KOPI_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__KOPI_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__KOPI_REACT_JSX__'),
    react: shimUrl('__KOPI_REACT__')
  }
