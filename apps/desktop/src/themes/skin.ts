/**
 * Kopi skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$KOPI_HOME/skins/` (or a
 * built-in) resolved by `kopi_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Kopi authors from a prompt lights up all three surfaces from one file.
 *
...
import type { KopiSkin, SkinColors } from '@kopi/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: KopiSkin): DesktopTheme | null {
