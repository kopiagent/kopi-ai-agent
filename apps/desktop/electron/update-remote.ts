 ...
 *
 * A public install can end up with `origin=git@github.com:kopiagent/kopi-ai-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/kopiagent/kopi-ai-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/kopiagent/kopi-ai-agent'
