...
export const ZOOM_STORAGE_KEY = 'kopi:desktop:zoomLevel'
 ...
 * but forgot to emit 'kopi:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('kopi:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
