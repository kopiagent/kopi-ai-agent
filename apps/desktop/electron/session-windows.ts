...
// by main.ts (`setBackgroundThrottling` driven by the merged `kopi:active-work`
...
// (the "Kopi idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Kopi" wake word has NO preceding click,
