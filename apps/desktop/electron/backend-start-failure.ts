 ...
 * startKopi() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startKopi() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startKopi`, re-emits
