/**
 * Canonical Kopi skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$KOPI_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`kopi_cli/skin_engine.py`),
 ...
 *   • CLI     → `kopi_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
